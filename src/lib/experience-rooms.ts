...
export const experienceRooms: ExperienceRoom[] = [
  {
    ...
    chapter: "Chapter 01",
    description:
      "The street gives nothing away. There is no marquee or velvet rope theatre, only a discreet doorway and the sense that the building itself has been waiting for you. The house is the attraction, and the approach is the first act.",
    emotionalObjective:
  ...
  },
  {
    ...
    chapter: "Chapter 02",
    description:
      "A vestibule between two worlds. Heavy velvet, dark lacquer, a single sculptural light. Here the pace changes. Coats are taken, phones are softened and the outside self is set down before the house reveals itself.",
    ...
    scentProfile: "The signature house scent is introduced here as the olfactory 'logo'.",
  ...
  },
  {
    ...
    chapter: "Chapter 03",
    description:
      "The heart of the residence. Collected art layered on dark walls, vintage velvet, aged brass, pools of lamplight. It feels lived-in by someone impossibly interesting. This is a home, not a venue.",
    emotionalObjective: "Belonging and fascination, with the legendary creative-residence energy of a place that has a long, glamorous memory.",
  ...
  },
  {
    ...
    chapter: "Chapter 07",
    description:
      "A bohemian room for the unplanned, with instruments in the shadows, velvet seating drawn into a circle and walls thick with collected work. This is where the house's rebellious, creative spirit gathers and improvises.",
  ...
  },
  {
    ...
    chapter: "Chapter 08",
    description:
      "A door within a bookshelf, ajar on a sliver of coloured light. The house rewards curiosity with rooms that are not on any map. Reveals are earned rather than advertised.",
    ...
    guestRitual: "Discovery is unscripted. Staff never point the way, because the house tests your curiosity.",
  ...
  },
  {
    ...
    chapter: "Chapter 09",
    description:
      "An intimate stage under a single spotlight, a mirror ball scattering light across empty velvet seats. The house is programmed for moments: a voice, a set, a surprise, all engineered around a single feeling.",
  ...
  },
  {
    ...
    chapter: "Chapter 10",
    description:
      "Open air, held privately. Lush planting, low lounges, lantern light and a fire feature against the city glow create a place to exhale between chapters without ever leaving the world of the house.",
    ...
    hiddenDiscovery: "A concealed corner seats only two. It is the most requested spot in the house.",
    engineeringNotes: [
  ...
  },
  {
    ...
    scentProfile: "The house scent follows you out on your coat, becoming a memory you carry home.",
